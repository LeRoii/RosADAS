...
def parse_args():
    ...
    parser.add_argument("--img_path", '-i', type=str, default="/media/iairiv/My Passport1/yuege/_lane/fc2_save_2020-06-03-111351-0000", help="Path to demo img")
...
def main():
    ...
    for img_name in os.listdir(img_root):
        ...
        cv2.imwrite("demo_result/{}_result.jpg".format(img_name[:-4]), img)
