...
test_loader = DataLoader(test_dataset, batch_size=16, collate_fn=test_dataset.collate, num_workers=4)
...
eval_result = LaneEval.bench_one_submit(os.path.join(out_path, "predict_test.json"),
                                        "/media/iairiv/7f072dbd-7037-43d9-9b3f-e8b67a86e0be/home/admin1/DATA/Tusimple/train_set/test_label.json")
print(eval_result)
