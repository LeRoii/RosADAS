...
class LaneWarning(object):
    ...
    def process(self, dict):
            ...
            convcar_X = self.cal_conv_lane_X(LaneWarning.formcar_X, LaneWarning.formcar_Y)
            convcar_Y = self.cal_conv_lane_Y(LaneWarning.formcar_X, LaneWarning.formcar_Y)
            ...
            left, right, state = self.cal_avr_dis(LaneWarning.temp_dis, dis/4, dis2/4)
            ...
            mid_distances = self.mid_dis(LaneWarning.mid_distances, dis_mid, state)  # 更新mid_distances表
            ...
            speed = self.cal_speed(mid_distances, LaneWarning.derta_time)
            #print("速度：")
            ...
            if (len(LaneWarning.mid_distances) < 5):
                print("数据未加载完成")
                print("------------------------------------------------")
                return 3

            elif time < 15 or (self.cal_theta(mid_distances) == 1 and distance[1] < 90 - LaneWarning.half_car_weight) or (self.cal_theta(mid_distances) == 0 and distance[0] < 90):
